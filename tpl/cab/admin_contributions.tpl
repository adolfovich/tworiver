        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
              ...
              <button type="button" class="btn btn-primary" onClick="loadModal('modal_add_contribution', 'type=membership')">Создать взнос</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
              ...
              <button type="button" class="btn btn-primary" onClick="loadModal('modal_add_contribution', 'type=target')">Создать взнос</button>
            </div>
          </div>
        </div>
      </div>
...
<script>
  function addContribution() {
    ...
    formData = $("#add_contribution").serialize();
    $.ajax({
      type: "POST",
      url: "/pages/cab/ajax/add_contribution.php",
      data: formData,
