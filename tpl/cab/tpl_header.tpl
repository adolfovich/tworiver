<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
    <a class="navbar-brand brand-logo mr-5" href="/cab"><img style="height: 55px; margin-left: 20px; width: 100%;" src="/img/logo.png" class="mr-2" alt="logo"/></a>
    <a class="navbar-brand brand-logo-mini" href="/cab"><img style="height:auto;" src="/img/logo-mini.png" alt="logo"/></a>
  </div>
