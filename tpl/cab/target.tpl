          ...
          <div class="card-body">
            ...
            <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                ...
                <div class="col-md-6 ">
                  ...
                  <?php } ?>
                  <div class="mb-3" style="font-size: 2em; width: 100%;"><a href="#" class="btn btn-primary btn-sm btn-block" onClick="loadModal('modal_receipt_target')">Распечатать квитанцию</a></div>
                </div>
