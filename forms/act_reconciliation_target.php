<?php
	...
	$result_user_contributions = mysql_query("SELECT * FROM users_contributions WHERE user = $user_id AND contribution_type = 2 AND date BETWEEN '$date_from' AND '$date_to'") or die(mysql_error());
	//users_contributions
			...
			<div class="col-md-12">
				...
				<table style="width: 100%;">
					<tr>
						...
						<h4>Акт сверки оплаты по целевым взносам</h4>
