...
<table class="invoice">
	...
	<tr>
		<td class="noborder">
			<table class="numeral_table">
				<tr>
					<td style="border:none; text-align: right; width: 200px; font-weight: 100; vertical-align: top;" rowspan="2"><b>Вид платежа:</b><br>оплата целевых взносов</td>
					...
					<td style="border:none; vertical-align: top; padding: 0 !important; width: auto;">
						<table class="numeral_table">
							...
							if ($tmp[0] == "") {
								...
								foreach (str_split($targets_sum[1]) as $value) {
									echo "<td>$value</td>";
								}
							}
							?>
