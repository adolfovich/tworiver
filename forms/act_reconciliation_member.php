<?php
	...
	$result_user_contributions = mysql_query("SELECT * FROM users_contributions WHERE user = $user_id AND contribution_type = 1") or die(mysql_error());
	//users_contributions
		...
		<div class="row">
			<div class="col-md-12">
				...
				<table style="width: 100%;">
					<tr>
						<td colspan="3" style="text-align: center;"><h4>Акт сверки оплаты по членским взносам</h4></td>
					</tr>
					<tr>
			...
			<div class="col-md-12">
				...
				<table class="table table-bordered table-condensed" style="font-size: 10px;">
					<tr>
						...
						<th style="padding: 2px;">Период</th>
						...
						while ($user_contributions = mysql_fetch_assoc($result_user_contributions)) {
							...
							echo '<td>'.$user_contributions['quarter'].' квартал '.$user_contributions['year'].' года</td>';
