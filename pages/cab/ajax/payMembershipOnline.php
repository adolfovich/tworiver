...
if ($paysystem == 'sberpay') {
	...
	if ($amount > 0 && $amount <= 1500000) {
		...
		$description = 'Оплата членских взносов #'.$order_id." | участок №".$user['uchastok'];
		...
		$post_data = array(
			...
			'returnUrl' => 'https://xn----dtbffa7byadkn0c6c.xn--p1ai/cab/membership',
		...
		/*if($result_json = curl_exec($curl) === false)
		{
