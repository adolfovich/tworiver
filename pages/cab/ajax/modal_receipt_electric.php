...
if (isset($_SESSION['id'])) {
  ...
  $json['header'] = 'Квитанция для оплаты электроэнергии';
  $json['html'] .= '<form>';
  ...
  $json['html'] .= '<button class="btn btn-success" onClick="window.open(\'/pages/cab/forms/?pay_electric=\'+document.getElementById(\'electricAmount\').value, \'_blank\');" >Распечатать</button>';
